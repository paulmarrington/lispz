...
try{
tag.update_$_({'context':("panel-"+(opts.context||"default"))})//#riot-tags:2
...
try{
switch(false){case !opts.height:var px=opts.height;//#riot-tags:5

switch(false){case !("%"===opts.height.slice(-1))//#riot-tags:6
:var px=((window.innerHeight*opts.height.slice(0,-1))/100);//#riot-tags:7
}//#core:100
//#riot-tags:8

dom.style_$_(tag.outer,{'height':(px+"px")})//#riot-tags:9
}//#core:100
//#riot-tags:10
...
try{
sortable.create(tag.root,(opts.name||"sortable"),{'draggable':".draggable",'handle':".panel-title",'dataIdAttr':"name"})//#riot-tags:6
...
try{
lispz.load("dom"//#core:388
,function(){var dom=lispz.cache["dom"];
switch(false){case !opts.buttons:var buttons=lispz.globals.stateful.array_$_();//#riot-tags:3

tag.update_$_({'buttons':buttons.array_$_})//#riot-tags:4
...
title.shift()}//#core:100
//#riot-tags:7

var name=title;//#riot-tags:8

buttons.push_$_({'title':title,'type':type,'name':name})//#riot-tags:9
}
)//#riot-tags:10
}//#core:100
//#riot-tags:11
...
riot.tag2('buttons', '<div class="btn-toolbar {right: opts.align === \'right\'}" role="toolbar"> <yield></yield> </div>', 'buttons > div.right { float: right; margin-right: 1em }', '', function(opts) {
}, '{ }');

riot.tag2('button-group', '<div class="btn-group" role="group"> <yield></yield> </div>', '', '', function(opts) {
});
...
try{
tag.button.addEventListener("click",function(_t_){message.send(opts.name,{})}
)//#riot-tags:2
...
try{
message.listen(opts.name,function(items){riot.update_$_(tag,{'items':items,'root':(items||[])})//#riot-tags:3
}
)//#riot-tags:4

$(tag.dropdown).on("show.bs.dropdown",function(){message.send((opts.name+"/open"))
riot.update_$_(tag,{'items':tag.root})//#riot-tags:7
}
)//#riot-tags:8

tag.update_$_({'goto':function(ev){switch(false){case !ev.item.topic:message.send((opts.owner+"/"+ev.item.topic)//#riot-tags:11
,{'item':ev.item,'owner':opts.owner,'action':"select"})}//#core:100
//#riot-tags:12

switch(false){case !ev.item.children:tag.update_$_({'items':ev.item.children})//#riot-tags:14

ev.currentTarget.blur()//#riot-tags:15

ev.stopPropagation()//#riot-tags:16
}//#core:100
//#riot-tags:17
}
})//#riot-tags:18
...
try{
lispz.load("message,riot"//#core:388
,function(){var message=lispz.cache["message"],riot=lispz.cache["riot"];
message.listen(opts.name,function(items){riot.update_$_(tag,{'children':{'base':{'children':items}}})//#riot-tags:3
...
try{
lispz.load("message,dict"//#core:388
,function(){var message=lispz.cache["message"],dict=lispz.cache["dict"];
tag.on("update",function(data){switch(false){case !(opts.name&&tag.parent.children):tag.update_$_({'items':tag.parent.children[opts.name]["children"]})//#riot-tags:4

switch(false){case !(tag.items&&tag.items.length)//#riot-tags:5
:tag.update_$_({'children':dict.from_list(tag.items,"title")})//#riot-tags:6
}//#core:100
//#riot-tags:7
}//#core:100
//#riot-tags:8
...
tag.update_$_({'goto':function(ev){var item=ev.item.item;//#riot-tags:12

var topic=(item.topic||item.title);//#riot-tags:13

switch(false){case !topic:message.send(topic,{'item':item,'action':"select"})}//#core:100
//#riot-tags:15

switch(false){case !item.children:var tree=ev.currentTarget.nextElementSibling;//#riot-tags:17

tree.classList.toggle("open")//#riot-tags:18

tree.parentElement.classList.toggle("bg-info")//#riot-tags:19
}//#core:100
//#riot-tags:20

ev.stopPropagation()//#riot-tags:21
}
})//#riot-tags:22
}
//#core:389
...
try{
lispz.load("message,dom"//#core:388
,function(){var message=lispz.cache["message"],dom=lispz.cache["dom"];
var hamburger=lispz.globals.stateful.morph_$_(tag.hamburger);//#riot-tags:2

hamburger.update_$_({'onclick':function(){tag.sidebar.classList.toggle("toggled")
setTimeout(function(){message.send("dom/page-content-wrapper-padding",tag.sidebar.offsetWidth)//#riot-tags:6
}
,300)//#riot-tags:7
}
})//#riot-tags:8
...
try{
setTimeout(function(){message.send("dom/page-content-wrapper-padding",tag.sidebar.offsetWidth)//#riot-tags:10
}
,300)
}
finally {
...
lispz.load("message,dom"//#core:388
,function(){var message=lispz.cache["message"],dom=lispz.cache["dom"];
message.listen("dom/page-content-wrapper-padding",function(px){dom.style_$_(tag.page_content_wrapper,{'paddingLeft':(px+"px")})//#riot-tags:3
}
)//#riot-tags:4
}
//#core:389
...
try{
lispz.load("dom,net,jquery,riot,message,bootstrap"//#core:388
...
dom.append_$_("head",dom.element("meta",{'name':"viewport",'content':"width=device-width, initial-scale=1"}//#riot-tags:3
))//#riot-tags:4
}
//#core:389
)
...
try{
tag.update_$_({'menu':"codemirror/menu",'heading':(opts.heading||"Edit")})//#riot-tags:2
...
try{
var filename_key=("code-editor/"+opts.name+"/filename");//#riot-tags:4

var cm=codemirror.open(tag._riot_id,tag.tags.panel.body);//#riot-tags:5
//#riot-tags:6

var open=function(packet){codemirror.set_mode(cm,packet.key)//#riot-tags:8

switch(false){case !(packet.key[0]!=="."):tag.update_$_({'heading':packet.key.split("/").slice(-1)[0]})//#riot-tags:10

tag.update()//#riot-tags:11
}//#core:100
//#riot-tags:12

localStorage.setItem(filename_key,packet.key)//#riot-tags:13

cm.setValue(packet.contents)//#riot-tags:14
}
;//#riot-tags:15
//#riot-tags:16

var contents_key=("code-editor/"+opts.name+"/contents");//#riot-tags:17

var filename=localStorage.getItem(filename_key);//#riot-tags:18

switch(false){case !filename:setTimeout(function(){open({'key':filename,'contents':localStorage.getItem(contents_key)})//#riot-tags:20
}
,100)}//#core:100
//#riot-tags:21

cm.on("change",events.delay(1000,function(){var contents=cm.getValue(),name=opts.name;
localStorage.setItem(contents_key,contents)//#riot-tags:24

message.send(("code-editor/"+name+"/change"),{'contents':contents,'name':name})//#riot-tags:25
}
))//#riot-tags:26
//#riot-tags:27

var append=function(packet){cm.replaceRange(packet.contents,CodeMirror.Pos(cm.lastLine()))//#riot-tags:29
}
;//#riot-tags:30
//#riot-tags:31

var contents=function(_t_){return cm.getValue()
}
;//#riot-tags:32
//#riot-tags:33

message.dispatch(("code-editor/"+opts.name),{'open':open,'append':append,'contents':contents})//#riot-tags:34
...
try{
tag.update_$_({'cm':CodeMirror(tag.wrapper,opts)})//#riot-tags:2
...
try{
tag.update_$_({'menu':"codemirror/menu"})//#riot-tags:2

tag.update_$_({'heading':"Edit"})//#riot-tags:3
...
try{
var filename_key=("codemirror/"+opts.name+"/filename");//#riot-tags:5

var cm=codemirror.open(tag._riot_id,tag.tags.panel.wrapper);//#riot-tags:6

tag.update_$_({'pad':lispz.globals.stateful({'setText':function(contents){cm.setValue(contents)}
//#riot-tags:8
,'on_ready':function(act){act()}
//#riot-tags:9
})})//#riot-tags:10
//#riot-tags:11

var open=function(packet){codemirror.set_mode(cm,packet.key)//#riot-tags:13

tag.update_$_({'heading':packet.key.split("/").slice(-1)[0]})//#riot-tags:14

localStorage.setItem(filename_key,packet.key)//#riot-tags:15

switch(false){case !packet.contents:tag.pad.setText(packet.contents)}//#core:100
//#riot-tags:16
...
switch(false){case !opts.db:var db=firebase.attach(("firepads/"+opts.name),opts.db);//#riot-tags:22

tag.update_$_({'pad':stateful.morph(Firepad.fromCodeMirror(db,cm,{'richTextShortcuts':false,'richTextToolbar':false}//#riot-tags:24
))})//#riot-tags:25

tag.pad.update_$_({'on_ready':function(act){tag.pad.on("ready",act)}
})//#riot-tags:26
;break;case !true:var contents_key=("codemirror/"+opts.name+"/contents");//#riot-tags:28

var filename=localStorage.getItem(filename_key);//#riot-tags:29

switch(false){case !filename:setTimeout(function(){open({'key':filename,'contents':localStorage.getItem(contents_key)})//#riot-tags:32
}
,100)}//#core:100
//#riot-tags:33

cm.on("change",function(){localStorage.setItem(contents_key,cm.getValue())}
)//#riot-tags:36
//#riot-tags:37
}//#core:100
//#riot-tags:38
...
tag.pad.on_ready(function(){message.dispatch(("firepad/"+opts.name),{'open':open})}
)//#riot-tags:42
...
try{
tag.update_$_({'menu':opts.menu,'heading':opts.heading})//#riot-tags:2
...
try{
var iframe=tag.tags.panel.iframe;//#riot-tags:4

var iframe_doc=(iframe.contentDocument||iframe.contentWindow.document);//#riot-tags:5
//#riot-tags:6

switch(false){case !opts.src:iframe.setAttribute("src",opts.src)}//#core:100
//#riot-tags:7
//#riot-tags:8

tag.update_$_({'open':function(packet){tag.update_$_({'heading':(packet.heading||tag.heading)})//#riot-tags:11

switch(false){case !packet.menu:tag.update_$_({'menu':packet.menu})}//#core:100
//#riot-tags:12

iframe_doc.open()//#riot-tags:13

iframe_doc.write(("<!DOCTYPE html><html><head><meta charset='utf-8'>"+(packet.head||"")+"</head><body>"+(packet.body||"")+"</body></html>"))//#riot-tags:17

iframe_doc.close()//#riot-tags:18

tag.update()//#riot-tags:19
}
//#riot-tags:20
})//#riot-tags:21
...
try{
lispz.load("message,riot,dict"//#core:388
,function(){var message=lispz.cache["message"],riot=lispz.cache["riot"],dict=lispz.cache["dict"];
lispz.set_debug_mode(true)//#riot-tags:2
//#riot-tags:3

var open=function(topic,key,contents){message.send(("code-editor/"+topic),{'action':"open",'key':key,'contents':contents})//#riot-tags:5
}
;//#riot-tags:6
//#riot-tags:7

lispz.globals._h_resolve_deferred(message.ready("code-editor/code")).then(function(){open("code",".lispz","")
}
)//#core:618
//#riot-tags:8
//#riot-tags:9

var clear_result_panels=function(_t_){open("output",".txt","")
open("compiled",".js","")//#riot-tags:11
}
;//#riot-tags:12

message.listen("code-editor/run/prepare",clear_result_panels)//#riot-tags:13
//#riot-tags:14

var log=function(output){message.send("code-editor/output",{'action':"append",'key':".text",'contents':(output+"\n")//#riot-tags:19
})//#riot-tags:20
}
;//#riot-tags:21
//#riot-tags:22

lispz.load("js_beautify,compilers"//#core:388
,function(){var js_beautify=lispz.cache["js-beautify"],compilers=lispz.cache["compilers"];
var compiler=compilers["lispz"];//#riot-tags:24

message.listen("code-editor/run/compiled",function(compiled){open("compiled",".js",window.js_beautify(compiled.js))//#riot-tags:26
}
)//#riot-tags:27

var compile_and_show=function(source){clear_result_panels()//#riot-tags:29

var compiled=compiler.compile(source,"Scratchpad");//#riot-tags:30

var js=window.js_beautify(compiled.join(""));//#riot-tags:31

open("compiled",".js",js)//#riot-tags:32
...
message.listen("code-editor/code/change",function(_t_){compile_and_show(_t_.contents)}
//#riot-tags:36
)//#riot-tags:37

message.listen("code/run",function(_t_){lispz.globals._h_resolve_deferred(message.send("code-editor/code",{'action':"contents"})).then(function(source){var compiled=compile_and_show(source);//#riot-tags:40

compilers.run(compiled).filter(function(_t_){return _t_
}
).forEach(function(_t_){log(_t_)}
)//#riot-tags:41
}
)//#core:618
//#riot-tags:42
...
lispz.globals.stateful.morph_$_(console)//#riot-tags:46

console.update_$_({'log':function(_t_){log((lispz.slice.call(arguments,0).join(" ")))}
})//#riot-tags:47

message.listen("code-editor/run/output",function(_t_){log(_t_.output)}
)//#riot-tags:48
}
//#core:389
)
...
['code-editor','code-editor','code-editor','markdown']]
