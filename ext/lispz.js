...
message.wait_for("code-editor/scratch",(function(){message.send("code-editor/scratch",{'action':"open",'key':"scratchpad.lispz",'contents':null})//#riot-tags:6
}))//#riot-tags:7
}))//#riot-tags:8

});

return '<!-- using bootstrap code-editor -->'}
...
tag.on("mount",(function(){tag.context=("panel-"+(opts.context||"default"));//#riot-tags:4

tag.on("mount",(function(){switch(false){case !opts.height:var px=opts.height;//#riot-tags:7

switch(false){case !("%"===opts.height.slice(-1))//#riot-tags:8
:var px=((window.innerHeight*opts.height.slice(0,-1))/100);//#riot-tags:9
}//#riot-tags:10

tag.outer.style.height=(px+"px");//#riot-tags:11
}//#riot-tags:12
}))//#riot-tags:13
}))//#riot-tags:14
...
tag.on("mount",(function(){lispz.load("message"//#core:49
...
$(tag.dropdown).on("show.bs.dropdown",(function(){tag.items=root;//#riot-tags:10

tag.update()//#riot-tags:11
}))//#riot-tags:12

tag.goto=(function(ev){switch(false){case !ev.item.topic:message.send((opts.owner+"-"+ev.item.topic)//#riot-tags:15
,{'item':ev.item,'owner':opts.owner,'action':"select"})}//#riot-tags:16

switch(false){case !ev.item.children:tag.items=ev.item.children;//#riot-tags:18

ev.currentTarget.blur()//#riot-tags:19

ev.stopPropagation()//#riot-tags:20
}//#riot-tags:21
});//#riot-tags:22
}))}))//#riot-tags:23
...
lispz.tags['code-editor']=function(){riot.tag('code-editor', '<panel height="{ opts.height }" heading="{ heading }" menu="{ menu }" owner="{ _id }"> <div name=wrapper class=wrapper></div> </panel>', 'code-editor .wrapper { position: absolute; top: 0; bottom: 0; left: 0; right: 0; height: initial; } code-editor .CodeMirror { position: absolute; top: 0; bottom: 0; left: 5px; right: 0; height: initial; }', function(opts) {var tag=this;//#riot-tags:2

tag.menu="CodeMirror-menu";//#riot-tags:3

tag.heading="Edit";//#riot-tags:4

tag.on("mount",(function(){lispz.load("codemirror,message,dict"//#core:49
,(function(){var codemirror=lispz.cache["codemirror"],message=lispz.cache["message"],dict=lispz.cache["dict"];
var filename_key=("code-editor/"+opts.name+"/filename");//#riot-tags:6

var cm=codemirror.open(tag._id,tag.tags.panel.wrapper);//#riot-tags:7
//#riot-tags:8

var open=(function(packet){codemirror.set_mode(cm,packet.key)//#riot-tags:10

tag.heading=packet.key.split("/").slice(-1)[0];//#riot-tags:11

localStorage[filename_key]=packet.key;//#riot-tags:12

switch(false){case !packet.contents:cm.setValue(packet.contents)}//#riot-tags:13

tag.update()//#riot-tags:14
});//#riot-tags:15
//#riot-tags:16

var contents=("code-editor/"+opts.name+"/contents");//#riot-tags:17

var filename=localStorage[filename_key];//#riot-tags:18

switch(false){case !filename:setTimeout((function(){open({'key':filename,'contents':localStorage[contents]})//#riot-tags:20
}),100)}//#riot-tags:21

cm.on("change",(function(){localStorage[contents]=cm.getValue();//#riot-tags:23
}))//#riot-tags:24
//#riot-tags:25

message.dispatch(("code-editor/"+opts.name),{'open':open})//#riot-tags:26
}))}))//#riot-tags:27
...
lispz.tags['codemirror']=function(){riot.tag('codemirror', '<div name=wrapper> </div>', function(opts) {var tag=this;//#riot-tags:2
